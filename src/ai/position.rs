...
#[cfg(test)]
pub mod tests {
    use crate::ai::position::{decode_positions, reverse_token_of_board};

    #[test]
    fn test_encode_positions() {
        use crate::ai::position::encode_positions;
        let positions = 0b0;
    ...
    fn test_get_token_at() {
        use crate::ai::position::get_token_at;
    ...
    fn test_create_token_iter() {
        use crate::ai::position::create_token_iter;
        let board1: u64 = 0b0;
